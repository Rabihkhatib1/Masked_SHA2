...
//     uint64_t  length, initial_hash[8];
//     uint64_t curlen;
...
// #define ROTR64(n, b) \
//     ((uint64_t)n >> (uint64_t)b) | ((uint64_t)n << (uint64_t)(64-b)) & 0xFFFFFFFFFFFFFFFF
...
//     ctx->curlen = 0;
//     ctx->length = 0;
//     ctx->initial_hash[0] = 0x6a09e667f3bcc908;
//     ctx->initial_hash[1] = 0xbb67ae8584caa73b;
//     ctx->initial_hash[2] = 0x3c6ef372fe94f82b;
//     ctx->initial_hash[3] = 0xa54ff53a5f1d36f1;
//     ctx->initial_hash[4] = 0x510e527fade682d1;
//     ctx->initial_hash[5] = 0x9b05688c2b3e6c1f;
//     ctx->initial_hash[6] = 0x1f83d9abfb41bd6b;
//     ctx->initial_hash[7] = 0x5be0cd19137e2179;

//     return 0;
// }

// int sha512(const unsigned char *message, uint64_t msg_len, unsigned char *output) {
//     sha512_ctx ctx;
//     if (!sha512_init(&ctx)) {
//         return INIT_ERROR;
//     }
